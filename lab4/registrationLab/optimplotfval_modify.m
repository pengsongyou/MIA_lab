function stop = optimplotfval_modify(~,optimValues,state,varargin)
...
% Modified by Songyou Peng, April 29th, 2016
...
if iteration == 0
    plotfval = plot(iteration,fval,'-','LineWidth',1,'MarkerFaceColor',[1 0 1]);
